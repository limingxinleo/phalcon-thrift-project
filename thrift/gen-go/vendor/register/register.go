...
func NewRegisterProcessor(handler Register) *RegisterProcessor {
  ...
  self2 := &RegisterProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self2.processorMap["version"] = &registerProcessorVersion{handler:handler}
return self2
}
